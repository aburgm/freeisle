...
TEST(Bitmask, DefaultCtor) {
  freeisle::Bitmask<TestEnum> mask;
...
TEST(Bitmask, SingleBit) {
  freeisle::Bitmask<TestEnum> mask1(TestEnum::Test1);
  ...
  freeisle::Bitmask<TestEnum> mask2(TestEnum::Test2);
  ...
  freeisle::Bitmask<TestEnum> mask3(TestEnum::Test3);
...
TEST(Bitmask, MultipleBits) {
  freeisle::Bitmask<TestEnum> mask1(TestEnum::Test1, TestEnum::Test2);
  EXPECT_TRUE(mask1.is_set(TestEnum::Test1));
  ...
  freeisle::Bitmask<TestEnum> mask2(TestEnum::Test1, TestEnum::Test3);
  ...
  freeisle::Bitmask<TestEnum> mask3 = mask1;
...
TEST(Bitmask, ToggleBits) {
  freeisle::Bitmask<TestEnum> mask(TestEnum::Test1);
